...
<head>
    <meta charset="UTF-8">
    <title>Quartz Cron 生成工具</title>
    <%@ include file="/common/meta.jsp" %>
    <script type="text/javascript" src="${ctx}/js/cron.js"></script>
    <style>
        .line{
            height: 25px;
            line-height: 25px;
...
<div class="easyui-layout" style="width:830px;height:540px;border:1px rgb(202, 196, 196) solid;border-radius: 5px">
<div data-options="region:'center',border:false" title="CRON表达式配置">
